...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($gender_err) && empty($age_range_err) && empty($message_err) && empty($file_path_err) && empty($province_err) && empty($district_err) && empty($hospital_err)) {
        ...
        if ($stmt = $conn->prepare($sql)) {
            ...
            $stmt->bind_param("sssssssi", $param_gender, $param_age_range, $param_message, $param_file_path, $param_province, $param_district, $param_hospital, $param_id);

            // Set parameters
            $param_gender = $gender;
            $param_age_range = $age_range;
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <div class="form-group">
                ...
                <select name="age_range" class="form-control">
                    ...
                    <option value="19-30" <?php if ($age_range == '19-30') echo 'selected="selected"'; ?>>19-30</option>
                    <option value="31-50" <?php if ($age_range == '31-50') echo 'selected="selected"'; ?>>31-50</option>
                    <option value="51-70" <?php if ($age_range == '51-70') echo 'selected="selected"'; ?>>51-70</option>
                    <option value="71-above" <?php if ($age_range == '71-above') echo 'selected="selected"'; ?>>71 and above</option>
                </select>
